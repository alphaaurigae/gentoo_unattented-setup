...
#!/bin/bash
		...
		PRESET_VIDEODRIVER="amdgpu"  # amdgpu, radeonsi, radeon, virtualbox ; (!note: if running in virtualbox and intend to build firefox - run KVM and set to your hardware ... "avx2 error firefox")
...
CONFIG_VERSION_SIGNATURE="Ubuntu 5.4.0-64.72~18.04.1-generic 5.4.78"
CONFIG_SWAP=y
CONFIG_SYSVIPC=y
...
CONFIG_SND_SOC_SOF_COMETLAKE_H=y
...
CONFIG_RTL8192U=y
CONFIG_RTLLIB=y
CONFIG_RTLLIB_CRYPTO_CCMP=y
CONFIG_RTLLIB_CRYPTO_TKIP=y
CONFIG_RTLLIB_CRYPTO_WEP=y
CONFIG_RTL8192E=y
CONFIG_RTL8723BS=y
CONFIG_R8712U=y
CONFIG_R8188EU=y
